<template>
  <section class="mb-5">
    ...
    <time class="mb-6">Last updated August 11, 2024 </time>

    <p class="mb-4">
      This privacy notice for GenArt, Voloview ("
      <strong> we </strong>
      ," "
      <strong> us </strong>
      ," or "
    ...
    <p class="mb-4">
      ...
      <a href="mailto:info@voloview.com">info@voloview.com</a>.
    </p>
    ...
    <p class="mb-4">
      ...
      our Cookie Notice:
      <nuxt-link to="/cookie-notice">
        https://voloview.xyz/cookie-notice/
      </nuxt-link>
      .
    </p>
    <h2
    ...
    <p class="mb-4">
      ...
      us at <a href="mailto:info@voloview.com">info@voloview.com</a>.
    </p>
    <h2
      id="DNT"
      class="heading heading-is-2"
    ...
    <p class="mb-4">
      ...
      <a href="mailto:info@voloview.com">info@voloview.com</a>, or by referring to
    ...
    <p class="mb-4">
      You may contact us by email at
      <a href="mailto:info@voloview.com">info@voloview.com</a>, by submitting a
    ...
    <p class="mb-4">
      ...
      <a href="mailto:info@voloview.com">info@voloview.com</a> or contact us by
      post at:
    </p>
    <p class="mb-4">
  ...
  setup() {
    useHead({
      ...
      meta: [
        {
          name: 'description',
          content: 'Voloview Privacy Policy',
        },
      ],
    })
  },
